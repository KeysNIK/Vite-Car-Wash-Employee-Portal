...
--
-- Хост: 10.0.1.96
-- Время создания: Дек 22 2024 г., 03:38
...
--
-- Дамп данных таблицы `CarQueue`
--

INSERT INTO `CarQueue` (`ID`, `NumberCar`, `CarBrand`, `CarModel`, `CarColor`, `ClientsID`, `AcceptanceDate`, `Services`, `ExecutionTime`, `Price`, `status`) VALUES
(29, '6612AB-7', 'БМВ', 'Х3', 'Белый', 1, '2024-12-22', 29, 600, 410, 'pending');
...
--
-- Дамп данных таблицы `CarWashServicesQueue`
--

INSERT INTO `CarWashServicesQueue` (`ID`, `NumberCar`, `ServicesName`, `Price`, `ExecutionTime`) VALUES
(29, '', 'Полная мойка', 70, 40),
(29, '', 'Химчистка салона', 60, 180),
(29, '', 'Полировка кузова', 80, 300),
(29, '', 'Нанесение воска', 150, 60),
(29, '', 'Обработка стекол антидождем', 50, 20);
...
--
-- AUTO_INCREMENT для таблицы `CarQueue`
--
ALTER TABLE `CarQueue`
